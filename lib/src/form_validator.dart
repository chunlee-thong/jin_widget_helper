...
class FormValidator {
  ...
  static String validatePassword(String value, BuildContext context, {int length = 6}) {
  ...
  static String validatePhoneNumber(String value, BuildContext context) {
    ...
    return value.length > 6 && value.length < 17 ? null : "Please input a valid phone number";
  }
